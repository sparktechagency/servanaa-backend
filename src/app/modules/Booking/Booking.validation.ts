...
export const bookingValidationSchema = z.object({
  body: z.object({
    ...
    // Add bookingDate to the validation schema
    bookingDate: z.string().optional().or(z.date().optional()),
    ...
    periodInDays: z
      .number()
      .min(1, 'Period in days must be at least 1')
      .optional(),
    material: z.array(
      z.object({
        name: z.string(),
    ...
    day: z.union([
      ...
      z.enum([
        ...
        'Saturday',
        'Sunday'
      ]), // OneTime - weekday name (current format)
      z.array(
        z.enum([
          'Monday',
          'Tuesday',
    ...
    startTime: z
      .string()
      .regex(/^\d{2}:\d{2}$/, 'Invalid timeSlot format (HH:mm)'),
    endTime: z
      .string()
      .regex(/^\d{2}:\d{2}$/, 'Invalid timeSlot format (HH:mm)')
      .optional(),
